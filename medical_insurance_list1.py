...
maria_insurance_cost = estimate_insurance_cost(name="Maria",
                                               age=31,
                                               sex=0,
                                               bmi=23.1,
                                               num_of_children=1,
...
rohan_insurance_cost = estimate_insurance_cost(name="Rohan",
                                               age=25,
                                               sex=1,
                                               bmi=28.5,
                                               num_of_children=3,
...
valentina_insurance_cost = estimate_insurance_cost(name="Valentina",
                                                   age=53,
                                                   sex=0,
                                                   bmi=31.4,
                                                   num_of_children=0,
...
print("Here is the estimate insurance cost data : " + str(estimate_insurance_data))
